    ...
    return [
        [
            ...
            sg.Input(
                ...
                visible=True,
                disabled=True,
                default_text=project_path,
            ),
            sg.FolderBrowse(
                "Choose folder of your project",
                initial_folder=project_path,
                target="_FILEBROWSE_",
            ),
        ...
        [
            sg.Column(
                [
                    ...
                    [
                        sg.Listbox(
                            values=database.retrieve_urls("original_urls"),
                            k="-SCANNED-URLS-",
                            size=(80, 20),
                            enable_events=True,
                        )
            ...
            sg.Column(
                [[sg.Button("==>", k="-ADD-FROM-LISTBOX-TO-LISTBOX-")]], expand_x=True
            ),
            sg.Column(
                [
                    [
                    ...
                    [
                        sg.Listbox(
                            values=database.retrieve_urls("urls_and_attributes"),
                            enable_events=True,
                            k="-USER-URLS-",
                            size=(80, 20),
                        )
