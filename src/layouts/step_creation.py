    ...
    return [
        [
            ...
            [
                ...
                sg.Combo(
                    bdd_attributes,
                    default_value=bdd_attributes[0],
                    key="-ACTION-BDD-ATTRIBUTE-",
                    readonly=True,
                ),
                            ...
                            [
                                ...
                                [
                                    sg.Col(
                                        ...
                                        key="-NOT-USED-ONLY-FOR-PROPER-LAYOUT-",
                                        pad=(0, 0),
                                        visible=True,
                                    )
                                ],
        ...
        [
            sg.Column([[]], k="layout_principal", expand_x=True),
            sg.Checkbox(
                "Logged in", default=False, enable_events=True, k="-LOGGED-IN-"
            ),
            sg.Column([[]], k="layout_principal", expand_x=True),
        ],
        [sg.HorizontalSeparator()],
        [
                        ...
                        [
                            ...
                            sg.Column(
                                [
                                    [
                                        sg.Button(
                                            "Show whole html in external app",
                                            key="-SHOW-HTML-",
                                        )
                                    ],
                                    [
                                    ...
                                    [
                                        sg.Button(
                                            "Save xpath or info for input",
                                            k="-SAVE-CHANGED-XPATH-",
                                        )
                                    ],
                                ]
                            ),
            ...
            [
                sg.Button(
                    "Add new action",
                    k="-ADD-ACTION-",
                    tooltip=INFORMATION_ABOUT_UNIQUENESS,
                ),
                # sg.Button("Save action", k='-SAVE-ACTION-', tooltip=INFORMATION_ABOUT_UNIQUENESS),
                sg.Button(
                    "Delete selected action", k="-DELETE-ACTION-", button_color="red"
                ),
                sg.Column([[]], expand_x=True),
                sg.pin(
                    sg.Column(
                        [
                            [
                                sg.Text(
                                    "Write here your info for input",
                                    key="-HELPER-INPUT-LABEL-",
                                )
                            ],
                            [
                                sg.Input("Additional", key="-HELPER-INPUT-"),
                                sg.FileBrowse(
                                    "Choose folder of your project",
                                    target="-HELPER-INPUT-",
                                    visible=False,
                                    key="-HELPER-INPUT-FILE-BROWSE-",
                                ),
                                sg.Button(
                                    "Insert in input current domain",
                                    visible=False,
                                    button_color="#007373",
                                    key="-HELPER-INPUT-CURRENT-DOMAIN-",
                                ),
                                sg.Button(
                                    "Insert in input current domain with endpoint",
                                    visible=False,
                                    button_color="#008080",
            ...
            [
                ...
                [
                    sg.Column([[]], expand_x=True),
                    sg.Button(
                        "Generate plan as action",
                        k="-GENERATE-PLAN-AS-ACTION-",
                        button_color="green",
                    ),
                    sg.Button(
                        "Generate plan", k="-GENERATE-PLAN-", button_color="purple"
                    ),
                ],
            ],
        ],
