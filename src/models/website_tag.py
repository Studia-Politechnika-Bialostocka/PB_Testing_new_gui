class WebsiteTag:
    ...
    def get_attribute_from_gui(self):
        if (
            ...
            or self.this_is_saved_action is True
        ):
            return ""
    ...
    def get_command(self):
        if self.value_for_bdd == "visiting site":
            ...
            return (
                f"{self.bdd_attribute} waiting for amount of seconds {self.attribute}"
            )
            ...
            return (
                f"{self.bdd_attribute} input with xpath {self.xpath} should be disabled"
            )
            ...
            return (
                f"{self.bdd_attribute} input with xpath {self.xpath} should be visible"
            )
    ...
    def format_for_todo_listbox(self):
        return (
            f"{self.bdd_attribute} {self.value_for_bdd}{self.get_attribute_from_gui()}"
        )
